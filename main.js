...
function up()//Define function to move the car upward
{
	if(greencar_y >=0)
	{
...
function down()//Define function to move the car downward
{
	if(greencar_y <=800)
	{
		greencar_y = greencar_y + 10;
...
function left()//Define function to move the car left side
{
	if(greencar_x >=0)
	{
...
function right()//Define function to move the car right side
{
	if(greencar_x <=800)
	{
		greencar_x = greencar_x + 10;
